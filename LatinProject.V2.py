...
# ── Configuration ──────────────────────────────────────────────────────────────
DB_PATH = r"C:\Users\User\Latin Stories\master_key.db"
STORY_INPUT_PATH = r"C:\Users\User\Desktop\Latin Stories In\input.txt"
OUTPUT_FOLDER    = r"C:\Users\User\Desktop\Latin Stories Out"
...
def main():
    ...
    # Load and clean story — returns (lemma, original_word) tuples
